...
BLECharacteristic OrientationData = BLECharacteristic("1796883e-b9b1-11ec-8422-0242ac120002");
uint8_t data_tbs[25] = {};
...
void OrientationData2(void) {
  ...
  sprintf(buffer,"HL,%i,%i,%i",x,y,z);
  memcpy(data_tbs,buffer,sizeof(buffer));
  
  OrientationData.notify(data_tbs,25); 
...
void setup(void) {
  ...
  Bluefruit.begin();
  Bluefruit.setName("Hip Sensor L");
